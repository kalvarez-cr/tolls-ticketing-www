...
import { accountHolder, DefaultRootStateProps } from 'types'
import {
    blockAccountRequest,
...
const ReadUserAccount = () => {
    ...
    const [account, setAccount] = React.useState<accountHolder | undefined>(
        undefined
    )
