...
export const LIST_LIQUIDATION_CONCEPT = 'LIST_LIQUIDATION_CONCEPT'
export const ADD_LIQUIDATION_CONCEPT = 'ADD_LIQUIDATION_CONCEPT'
export const UPDATE_LIQUIDATION_CONCEPT = 'UPDATE_LIQUIDATION_CONCEPT'
export const DELETE_LIQUIDATION_CONCEPT = 'DELETE_LIQUIDATION_CONCEPT'

//action criterios de dicersion
...
//action lista negra de vehiculos
export const LIST_BLACKLIST_VEHICLE = 'LIST_BLACKLIST_VEHICLE'
export const ADD_BLACKLIST_VEHICLE = 'ADD_BLACKLIST_VEHICLE'
export const UPDATE_BLACKLIST_VEHICLE = 'UPDATE_BLACKLIST_VEHICLE'
export const DELETE_BLACKLIST_VEHICLE = 'DELETE_BLACKLIST_VEHICLE'

//action lista negra de tags
export const LIST_TAGLIST = 'LIST_TAGLIST'
...
//action data generada por reportes 
export const LIST_CONSOLIDATE_DATA = 'LIST_CONSOLIDATE_DATA'