...
import FareChangeProfile from './FareChangeProfile'
...
const FareChangeIndex = ({ fleetId, onlyView, readOnly }: CompanyProfileProps) => {
    // tabs
    ...
    const tabsOption = [
        {
            label: 'Cambio de tarifas',
            icon: <CategoriaFormIcon />,
            caption:
                'Cambio de tarifas masivo',
        },
        // {
...
export default FareChangeIndex
