    ...
    return (
        <>
            {theme.palette.mode === 'dark' ? (
                <div className="p-4 bg-gray-900 bg-opacity-20 rounded-xl">
                    <Tab.Group>
                        <div className="flex flex-col w-full mb-8 justify-center items-center gap-6 lg:flex-row lg:justify-between">
                            <Tab.List className="flex p-2 space-x-2 order-last rounded-xl bg-green-900 bg-opacity-40 lg:order-first">
                                <Tab
                                    className={({ selected }) =>
                                        classNames(
                                            ...
                                            selected
                                                ? 'bg-green-700 bg-opacity-30 shadow-md'
                                                : 'text-white hover:bg-opacity-40 hover:text-white'
                                        )
                                    }
                                >
                                    Ingresos
                                ...
                                <Tab
                                    className={({ selected }) =>
                                        classNames(
                                            ...
                                            selected
                                                ? 'bg-green-700 bg-opacity-30 shadow-md'
                                                : 'text-white hover:bg-green-200 hover:bg-opacity-40 hover:text-white'
                                        )
                                    }
                                >
                                    Vehículos
                            ...
                            <h2 className="text-white font-bold text-2xl pb-1 mt-0 mr-0 sm:mt-3 ">
                                Análisis de flujo
                            </h2>
                            <button
                                type="button"
                                className="lg:mr-1 bg-green-900 bg-opacity-70 hover:bg-opacity-50 rounded-lg shadow-lg p-4 font-bold text-white"
