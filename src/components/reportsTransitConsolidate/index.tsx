...
import ReportTransitDetail from './ReportTransitDetail'
...
const tabsOption = [
    {
        label: 'Reporte consolidado por tránsito',
        icon: <ConsolidadoIcon />,
        caption: 'Consolidado por tránsito',
    },
    // {
    //     label: 'Billing',
    //     icon: <ReportsIcome />,
...
export default DetailsReportsTransit
