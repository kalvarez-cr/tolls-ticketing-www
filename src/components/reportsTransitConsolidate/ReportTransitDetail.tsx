    ...
    const onSubmit: SubmitHandler<Inputs> = async (data) => {
        ...
        const fetchData = async () => {
            ...
            const responseData2 = await dispatch(
                getConsolidateTagReportRequest({
                    ...
                    report_type: 'detailed_transit_consolidated',
        ...
        if (diferentYear === 0 ) {
            ...
            if (responseData2) {
                ...
                navigate('/reportes/transit-detailed/tabla')
            }
        } else if (!open) {
            setOpen(true)
        } else if( open) {
        ...
        <>
            ...
            <Grid item sx={{ height: 20 }} xs={12}>
                <Typography variant="h3">
                    Reporte consolidado de tránsito
                </Typography>
            </Grid>
...
export default ReportTransitDetail
