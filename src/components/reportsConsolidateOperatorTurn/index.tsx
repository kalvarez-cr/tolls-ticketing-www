...
import ReportConsolidateOperatorTurn from './ReportConsolidateOperatorTurn'
...
const DetailsReportsConsolidateOperatorTurn = () => {
...
export default DetailsReportsConsolidateOperatorTurn
