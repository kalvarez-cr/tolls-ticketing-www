...
const ReportConsolidateOperatorTurn = () => {
    ...
    const onSubmit: SubmitHandler<Inputs> = async (data) => {
        ...
        const fetchData = async () => {
            ...
            const responseData2 = await dispatch(
                getConsolidateGenericReportRequest({
                    ...
                    report_type: 'consolidated_operator_shift',
        ...
        if (diferentYear === 0 ) {
            ...
            if (responseData2) {
                ...
                navigate('/reportes/consolidado-operador-turno/tabla')
            }
        } else if (!open) {
            setOpen(true)
        } else if( open) {
        ...
        <>
            ...
            <Grid item sx={{ height: 20 }} xs={12}>
                <Typography variant="h3">
                    Reporte consolidado de Operadores por Turno
                </Typography>
            </Grid>
...
export default ReportConsolidateOperatorTurn
