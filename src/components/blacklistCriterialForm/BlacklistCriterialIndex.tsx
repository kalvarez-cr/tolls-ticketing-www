...
import BlacklistCriterialProfile from './BlacklistCriterialProfile'
...
const FareIndex = ({ fleetId, onlyView, readOnly }: CompanyProfileProps) => {
    ...
    const tabsOption = [
        {
            label: 'Criterios de discerción',
            icon: <CategoriaFormIcon />,
            caption: 'Creación de criterios de discerción',
        },
        // {
