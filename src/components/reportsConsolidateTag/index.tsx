...
import ReportConsolidateTag from './ReportConsolidateTag'
...
const tabsOption = [
    {
        ...
        caption: 'Consolidación de tránsitos de peaje por tag',
    },
    // {
    //     label: 'Billing',
    //     icon: <ReportsIcome />,
...
const DetailsReportsConsolidateTag = () => {
...
export default DetailsReportsConsolidateTag
