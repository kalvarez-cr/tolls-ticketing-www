    ...
    const onSubmit: SubmitHandler<Inputs> = async (data) => {
        ...
        const fetchData = async () => {
            ...
            const responseData2 = await dispatch(
                getConsolidateTagReportRequest({
                    ...
                    report_type: 'overall_transit_consolidated',
        ...
        if (diferentYear === 0 ) {
            ...
            if (responseData2) {
                ...
                navigate('/reportes/consolidado/tag')
            }
        } else if (!open) {
            setOpen(true)
        } else if( open) {
...
export default ReportConsolidateTag
