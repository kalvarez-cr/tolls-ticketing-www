...
import ReportConsolidateTollTurn from './ReportConsolidateTollTurn'
...
const DetailsReportsConsolidateTollTurn = () => {
...
export default DetailsReportsConsolidateTollTurn
