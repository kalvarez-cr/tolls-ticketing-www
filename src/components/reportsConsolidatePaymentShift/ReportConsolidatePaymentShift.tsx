...
import { getReportGenerateRequest } from 'store/generateReport/generateReportAction'
...
const ReportConsolidatePaymentShift = () => {
    ...
    const onSubmit: SubmitHandler<Inputs> = async (data) => {
        ...
        const fetchData = async () => {
            ...
            if (responseData2) {
                ...
                navigate('/reportes/consolidado-payment-shift/tabla')
            }
        ...
        <>
            ...
            <Grid item sx={{ height: 20 }} xs={12}>
                <Typography variant="h3">
                    Reporte consolidado de métodos de pago por turno
                </Typography>
            </Grid>
...
export default ReportConsolidatePaymentShift
