...
import VehicleBlacklistProfile from './VehicleBlacklistProfile'
...
const FareIndex = ({ fleetId, onlyView, readOnly }: CompanyProfileProps) => {
    ...
    const tabsOption = [
        {
            label: 'Lista negra de vehículos',
            icon: <CategoriaFormIcon />,
            caption: 'Creación de lista negra para vehículos',
        },
        // {
