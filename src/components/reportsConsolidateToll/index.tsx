...
import ReportConsolidateToll from './ReportConsolidateToll'
...
const tabsOption = [
    {
        label: 'Reporte por consolidado por peaje',
        icon: <ConsolidadoIcon />,
        caption: 'Consolidación por peaje',
    },
    // {
    //     label: 'Billing',
    //     icon: <ReportsIcome />,
...
const DetailsReportsConsolidateToll = () => {
...
export default DetailsReportsConsolidateToll
