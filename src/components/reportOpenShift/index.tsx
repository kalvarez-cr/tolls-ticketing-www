...
import ReportOpenShift from './ReportOpenShift'
...
const tabsOption = [
    {
        label: 'Reporte de operador por turno de trabajo ',
...
export default DetailsReportsOpenShift
